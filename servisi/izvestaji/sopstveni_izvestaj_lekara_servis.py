...
class SopstveniIzvestajLekaraServis:
    def __init__(self, ulogovani_lekar, broj_dana_za_izvestaj):
    ...
    def formiraj_ispis_zauzeca(self):
        string_za_ispis = ""
        ukupno_zauzece = 0
        for dogadjaj in KalendarRepozitorijum.kreiraj_listu_zauzeca_lekara(self._ulogovani_lekar, self._pocetni_datum):
    ...
    def pripremi_izvestaj(self):
        ...
        IzvestajRepozitorijum.generisi_izvestaj_lekar(sadrzaj)
...
if __name__ == '__main__':
    SopstveniIzvestajLekaraServis("horacije442", 120)
