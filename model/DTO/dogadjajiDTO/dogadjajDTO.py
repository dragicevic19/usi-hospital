...
#     datum_pocetka = datetime.date(2020, 7, 10)
#     datum_zavrsetka = datetime.date(2020, 7, 15)
#     vreme_pocetka = '13:00'
#     vreme_zavrsetka = '08:00'
#
#     sati_pocetak, minuti_pocetak = vreme_pocetka.split(':')
#     sati_kraj, minuti_kraj = vreme_zavrsetka.split(':')
#     vreme_pocetka = datetime.time(int(sati_pocetak), int(minuti_pocetak))
#     vreme_zavrsetka = datetime.time(int(sati_kraj), int(minuti_kraj))
#     pocetak_vreme_datum = datetime.datetime.combine(datum_pocetka, vreme_pocetka)
#     kraj_vreme_datum = datetime.datetime.combine(datum_zavrsetka, vreme_zavrsetka)
#     razlika_datuma = kraj_vreme_datum - pocetak_vreme_datum
#     broj_termina = razlika_datuma.days * MINUTA_U_DANU / VREMENSKI_SLOT + razlika_datuma.seconds / 60 / VREMENSKI_SLOT
#
#     print(pocetak_vreme_datum)
#     print(kraj_vreme_datum)
#     print(razlika_datuma)
#     print(broj_termina)
