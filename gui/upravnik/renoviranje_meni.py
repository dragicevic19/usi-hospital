...
class RenoviranjeMeni:
    def __init__(self, top,prostorije_servis):
        ...
        self.TButton0.configure(text='''Izmena namena prostorije''',
                                command=lambda: poziv_forme_odabir_prostorije(TipRenoviranja.IZMENA_NAMENE,self._prostorije_servis))
        ...
        self.TButton1.configure(text='''Premestanje opreme kojom prostorija raspolaze''',
                                command=lambda: poziv_forme_odabir_prostorije(TipRenoviranja.PREMESTANJE_OPREME,self._prostorije_servis))

        self.TButton2 = ttk.Button(top)
        self.TButton2.place(relx=0.083, rely=0.489, height=59, width=498)
        self.TButton2.configure(text='''Deljenje prostorija''',
                                command=lambda: poziv_forme_odabir_prostorije(TipRenoviranja.DELJENJE_PROSTORIJE,self._prostorije_servis))
        ...
        self.TButton3.configure(text='''Spajanje prostorija''',
                                command=lambda: poziv_forme_odabir_prostorije(TipRenoviranja.SPAJANJE_PROSTORIJA,self._prostorije_servis))
        ...
        self.TButton4.configure(text='''Ostale renovacije''',
                                command=lambda: poziv_forme_odabir_prostorije(TipRenoviranja.OSTALE_RENOVACIJE,self._prostorije_servis))


def poziv_forme_za_renovaciju_prostorije(root,prostorije_servis):
    RenoviranjeMeni(root,prostorije_servis)
    root.mainloop()
